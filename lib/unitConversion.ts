...
import type { ExactUnit } from "@/lib/unitTables";

// The unit vocabulary itself lives in the SDK-free `unitTables` module so client
// bundles can use it; re-exported here so existing importers keep working.
export {
  EXACT_UNIT_FACTORS,
  countFamily,
  countUnitsCompatible,
  getExactUnitCategory,
  isCountUnit,
  normalizeExactUnit,
  parsePackageSize,
} from "@/lib/unitTables";
export type { ExactUnit, ExactUnitCategory } from "@/lib/unitTables";
